...
entry:
  %tensor1.addr = alloca <16 x i32>, align 64
  ...
  %layout1 = alloca <4 x i32>, align 4
  %padding1 = alloca <4 x i32>, align 4
  ...
  %tensor3_token = alloca i32, align 4
  %indirect-arg-temp3 = alloca <9 x i32>, align 64
  %tensor1 = load <16 x i32>, <16 x i32>* %0, align 64
  store <16 x i32> %tensor1, <16 x i32>* %tensor1.addr, align 64
  store <4 x i32> %tensor2, <4 x i32>* %tensor2.addr, align 16
  store <4 x i32> <i32 1, i32 1, i32 4, i32 4>, <4 x i32>* %shape1, align 4
  store <4 x i32> <i32 1, i32 1, i32 2, i32 2>, <4 x i32>* %shape2, align 4
  store <4 x i32> <i32 1, i32 1, i32 3, i32 3>, <4 x i32>* %shape3, align 4
  store <4 x i32> <i32 0, i32 0, i32 1, i32 1>, <4 x i32>* %layout1, align 4
  store <4 x i32> zeroinitializer, <4 x i32>* %padding1, align 4
  %1 = load <16 x i32>, <16 x i32>* %tensor1.addr, align 64
  %2 = load <4 x i32>, <4 x i32>* %shape1, align 4
  %3 = load <4 x i32>, <4 x i32>* %layout1, align 4
  %4 = load <4 x i32>, <4 x i32>* %padding1, align 4
  store <16 x i32> %1, <16 x i32>* %indirect-arg-temp, align 64
  %call = call i32 @tensor_typeinfo16(<16 x i32>* byval(<16 x i32>) align 64 %indirect-arg-temp, <4 x i32> %2, <4 x i32> %3, <4 x i32> %4)
  ...
  %7 = load <4 x i32>, <4 x i32>* %layout1, align 4
  %8 = load <4 x i32>, <4 x i32>* %padding1, align 4
  ...
  %call2 = call <9 x i32> @tensor_convolution(i32 %9, i32 %10)
  store <9 x i32> %call2, <9 x i32>* %tensor3, align 64
  %11 = load <9 x i32>, <9 x i32>* %tensor3, align 64
  %12 = load <4 x i32>, <4 x i32>* %shape3, align 4
  %13 = load <4 x i32>, <4 x i32>* %layout1, align 4
  %14 = load <4 x i32>, <4 x i32>* %padding1, align 4
  ...
  store i32 %call4, i32* %tensor3_token, align 4
  %15 = load <9 x i32>, <9 x i32>* %tensor3, align 64
  ret <9 x i32> %15
}
...
entry:
  ...
  %tensor1 = alloca <16 x i32>, align 64
  ...
  store <16 x i32> <i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16>, <16 x i32>* %tensor1, align 64
  store <4 x i32> <i32 1, i32 2, i32 3, i32 4>, <4 x i32>* %tensor2, align 16
  %0 = load <16 x i32>, <16 x i32>* %tensor1, align 64
  %1 = load <4 x i32>, <4 x i32>* %tensor2, align 16
  store <16 x i32> %0, <16 x i32>* %indirect-arg-temp, align 64
  %call = call <9 x i32> @foo(<16 x i32>* byval(<16 x i32>) align 64 %indirect-arg-temp, <4 x i32> %1)
