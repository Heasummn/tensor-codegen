...
typedef int _tensor_t9  __attribute__((__vector_size__(9*4)));
typedef int _tensor_t16  __attribute__((__vector_size__(16*4)));
typedef int _tensor_t36  __attribute__((__vector_size__(36*4)));
...
_token_t tensor_typeinfo9(_tensor_t9, _shape_t, _layout_t, _padding_t);
_token_t tensor_typeinfo36(_tensor_t36, _shape_t, _layout_t, _padding_t);
...
_tensor_t9 tensor_matmul9(_token_t, _token_t);
_tensor_t9 tensor_convolution(_token_t, _token_t);
